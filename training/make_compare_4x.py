"""4x quality on realistic compressed input: Bicubic | WebVSR 4x | Ground Truth."""
...
ImageDraw.Draw(canvas).text((8,6),"Bicubic 4x (of compressed LR)   |   WebVSR 4x   |   Ground Truth", fill=(210,210,210))
y=24
